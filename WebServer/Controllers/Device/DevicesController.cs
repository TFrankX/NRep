...
namespace WebServer.Controllers.Device
{
    public class PowerBankToPush 
    {
        ...
        public uint PowerBankNum { get; set; }
    }
    public class DevicesController : Controller
    {
        ...
        public IActionResult PushPB([FromBody] PowerBankToPush powerBankToPush)
        {
            ...
            if (powerBankToPush == null || string.IsNullOrEmpty(powerBankToPush.DeviceName))
            ...
            foreach (var server in scanDevices.DevicesData.Servers)
            {
                ...
                if (server.Id == powerBankToPush?.ServerId)
                {
                    if ((powerBankToPush.PowerBankNum) == 0)
                    {
                    ...
                    {
                        server.CmdPushPowerBank(powerBankToPush.PowerBankNum, powerBankToPush.DeviceName);
